...
public class UpdatePermissionMain {
	...
	public static void main(String[] args) {
		...
		permission.setId(1L);
		permission.setName("Changeit");
		permission.setDescription("Changed");
		System.out.println("Permission persisted (updated): " + permissionRepository.save(permission).getId());
