...
public class UpdatePaymentMethodMain {
	...
	public static void main(String[] args) {
		...
		paymentMethod.setDescription("Changeit");
		System.out.println("PaymentMethod persisted (updated): " + paymentMethodRepository.save(paymentMethod).getId());
